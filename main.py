...
print("\n\n\nUsing subSetOfTech dataset subSetOfTech[90:152]"); runExec(subSetOfTech[0:70]); print("\n\n\nUsing subSetOfTech dataset subSetOfTech[90:152]"+str(datetime.datetime.now()))
